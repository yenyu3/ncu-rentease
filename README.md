...
#### 步驟 1: 複製專案
```bash
git clone https://github.com/yenyu3/ncu-rentease.git
...
2. 確保手機和電腦連接同一個 WiFi
3. 使用 Expo Go 掃描終端機中的 QR 碼
4. 等待應用程式載入完成

### 💻 Web 版本 (開發中)
```bash
cd ncu_rentease  # Web 版本路徑
npm install
npm run dev
```
...
### 🔧 常見問題
- **端口被占用**: 選擇 Y 使用其他端口
- **手機無法連接**: 確認 WiFi 連接，關閉防火牆
- **載入失敗**: 在 Expo Go 中搖動手機選擇 "Reload"
